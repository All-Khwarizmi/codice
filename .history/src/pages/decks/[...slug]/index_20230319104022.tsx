                ...
                <div className="max-w-xs text-white lg:max-w-sm" key={deck._id}>
                  <Link href={`./decks/${deck.name}`}>
                    ...
                    <div className="rounded-lg  rounded-t-none bg-gray-700">
                      <div>
                        <p className="text-md p-5 pb-3 font-bold uppercase">
                          {deck.name}
                        </p>
                        <p className="pl-5 text-sm font-bold italic text-gray-400">
                          {deck.description}
                        </p>
                        <p className="p bg-black  pl-5  text-sm">
                          {" "}
                          {deck.difficulty?.name}{" "}
                        </p>
                      </div>
