...
console.log("Form", form)
  ...
  const handleTechnoName = (e: any) => {
    setForm((form) => (form.techno = e.target.value));
  }
        ...
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
            ...
            >
              ...
              <input value={form.name} onChange= type="text" placeholder="Name" />
              ...
              >
                ...
                />{" "}
                1
                <input value='inter' id="difficulty" name="difficulty" type="radio" /> 2
                <input value='expert' id="difficulty" name="difficulty" type="radio" /> 3
              </form>
            </div>
