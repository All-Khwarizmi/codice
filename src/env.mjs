...
const client = z.object({
  ...
  NEXT_PUBLIC_API_AUTH_HEADERS_KEY_GET_USER_TOPIC_RECALL: z.string(),
  NEXT_PUBLIC_API_GET_USER_TOPIC_RECALL_ENDPOINT: z.string(),
});
...
const processEnv = {
  ...
  NEXT_PUBLIC_API_AUTH_HEADERS_KEY_GET_USER_TOPIC_RECALL:
    process.env.NEXT_PUBLIC_API_AUTH_HEADERS_KEY_GET_USER_TOPIC_RECALL,
  ...
  NEXT_PUBLIC_API_GET_USER_TOPIC_RECALL_ENDPOINT:
    process.env.NEXT_PUBLIC_API_GET_USER_TOPIC_RECALL_ENDPOINT,
